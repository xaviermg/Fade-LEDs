...
void loop()
{
  ...
  analogWrite(led5, 42);    // posar PWM del pin 11 a 125
  ...
  analogWrite(led4, 42);    // posar PWM del pin 10 a 255
  analogWrite(led5, 85);    // posar PWM del pin 11 a 255
  ...
  analogWrite(led1, 0);    // posar PWM del pin 5 a 125
  analogWrite(led2, 0);    // posar PWM del pin 6 a 125
  analogWrite(led3, 42);    // posar PWM del pin 9 a 125
  analogWrite(led4, 85);    // posar PWM del pin 10 a 125
  ...
  delay(velocitat);           // es queden leds velocitat ms en aquest estat
   ...
   analogWrite(led0, 0);     // posar PWM del pin 3 a 60
  analogWrite(led1, 0);     // posar PWM del pin 5 a 60
  analogWrite(led2, 42);     // posar PWM del pin 6 a 60
  analogWrite(led3, 85);     // posar PWM del pin 9 a 60
  analogWrite(led4, 127);     // posar PWM del pin 10 a 60
  analogWrite(led5, 169);     // posar PWM del pin 11 a 60
  
  delay(velocitat);          // es queden leds velocitat ms en aquest estat
  
  analogWrite(led0, 0);    // posar PWM del pin 3 a 125
  analogWrite(led1, 42);    // posar PWM del pin 5 a 125
  analogWrite(led2, 85);    // posar PWM del pin 6 a 125
  analogWrite(led3, 127);    // posar PWM del pin 9 a 125
  analogWrite(led4, 169);    // posar PWM del pin 10 a 125
  analogWrite(led5, 211);    // posar PWM del pin 11 a 125
  
  delay(velocitat);           // es queden leds velocitat ms en aquest estat
  
  analogWrite(led0, 42);    // posar PWM del pin 3 a 255
  analogWrite(led1, 85);    // posar PWM del pin 5 a 255
  analogWrite(led2, 127);    // posar PWM del pin 6 a 255
  analogWrite(led3, 169);    // posar PWM del pin 9 a 255
  analogWrite(led4, 211);    // posar PWM del pin 10 a 255
  analogWrite(led5, 255);    // posar PWM del pin 11 a 255
   
  delay(velocitat);           // es queden leds velocitat ms en aquest estat
  
  analogWrite(led0, 85);    // posar PWM del pin 3 a 125
  analogWrite(led1, 127);    // posar PWM del pin 5 a 125
  analogWrite(led2, 169);    // posar PWM del pin 6 a 125
  analogWrite(led3, 211);    // posar PWM del pin 9 a 125
  ...
  analogWrite(led1, 169);     // posar PWM del pin 5 a 60
  analogWrite(led2, 211);     // posar PWM del pin 6 a 60
  ...
  analogWrite(led0, 169);    // posar PWM del pin 3 a 125
  analogWrite(led1, 211);    // posar PWM del pin 5 a 125
  ...
  analogWrite(led0, 211);    // posar PWM del pin 3 a 255
